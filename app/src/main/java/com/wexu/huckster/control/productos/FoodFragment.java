...
public class FoodFragment extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv = (RecyclerView) root.findViewById(R.id.reciclador1);
        rv.setHasFixedSize(true);

        List items = new ArrayList();

 //       Producto p=new Producto("Papas", "", 2000, "julizuoso", Producto.COMIDA, "");
...
//        items.add(r);
        ...
        RecyclerView.Adapter adapter = new ProductsAdapter(items);
